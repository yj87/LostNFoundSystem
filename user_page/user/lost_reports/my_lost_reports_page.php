...
<head>
    ...
    <title>My Lost Reports - User Dashboard</title>
    <link rel="stylesheet" href="my_lost_reports.css">
...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav>
                ...
                <div class="nav-group">
                    ...
                    <a href="report_lost_items_page.php" class="nav-item">
                        <span class="icon"><i class="fas fa-plus-circle"></i></span>
                        <span>Report Lost Item</span>
                    </a>
                    <a href="my_lost_reports_page.php" class="nav-item active">
        ...
        <div class="main-content">
            <header class="top-header">
                <div class="header-left">
                    ...
                    <div class="page-title-header">My Lost Reports</div>
                </div>
            ...
            <article class="content-area">
                <div class="page-header">
                    <div>
                        ...
                        <p>View all your lost item reports</p>
                    </div>
                    <a href="report_lost_items_page.php" class="btn-new">
    ...
    <script src="my_lost_reports.js"></script>
    <script>
