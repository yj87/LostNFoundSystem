...
function viewLostReportDetails(reportId) {
    window.location.href = `../item_details/view_item_details.html?id=${reportId}&type=lost&from=user`;
}

// View Claim Details 
function viewClaimDetails(claimId, itemId) {
    if (itemId) {
        window.location.href = `../item_details/view_item_details.html?id=${itemId}&type=found&from=user`;
    } else {
