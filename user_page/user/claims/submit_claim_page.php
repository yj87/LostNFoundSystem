...
<body>
        ...
        <aside id="sidebar">
            ...
            <nav>
                ...
                <div class="nav-group">
                    ...
                    <a href="my_claims_page.php" class="nav-item">
    ...
    <script>
        ...
        if (evidencePhotoInput) {
            evidencePhotoInput.addEventListener('change', function(e) {
                const file = e.target.files[0];
                if (file) {
                    selectedEvidencePhoto = file;
                    evidenceFileName.textContent = '📎 ' + file.name;
                    evidenceFileName.style.color = '#28a745';
