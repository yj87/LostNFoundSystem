...
<head>
    ...
    <title>Manage Found Items - Admin Panel</title>

    <link rel="stylesheet" href="../admin_dashboard.css">
    <link rel="stylesheet" href="admin_found_items.css">
...
<aside id="sidebar">
        ...
        <div class="main-content">
            <header class="top-header">
                <div class="header-left">
                    ...
                    <div class="page-title-header">Found Items Management</div>
                </div>
            ...
            <article>
                <div class="page-title">
                    ...
                    <p>View, edit, or delete any found item reported across the system.</p>
                </div>
                ...
                <div class="toolbar">
                    <div class="search-box">
                        ...
                        <input type="text" id="searchInput"
                            placeholder="Search by name, location, description, reporter..."
    ...
    <div class="modal-backdrop" id="deleteModal">
        <div class="modal-box">
            ...
            <div class="modal-actions">
                ...
                <button class="btn-confirm-delete" id="confirmDeleteBtn" onclick="confirmDelete()">
    ...
    <script src="admin_items.js"></script>
</body>
