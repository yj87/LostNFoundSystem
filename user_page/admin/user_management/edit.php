...
<body>
        ...
        <aside id="sidebar">
            ...
            <nav>
                ...
                <div class="nav-group">
                    ...
                    <a href="../claims/admin_claims.php" class="nav-item">
        ...
        <div class="main-content">
            <header class="top-header">
                <div class="header-left">
                    ...
                    <div class="page-title-header">Edit User</div>
                </div>
    ...
    <!-- Form wrapper centers the form vertically -->
        ...
        <div class="form-container">
            ...
            <form id="editUserForm" method="POST" action="update.php">
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Minimum 6 characters. Only enter if you want to change password.</div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary" id="submitBtn" style="background-color:#F5D3D6 ;">
                        <span><i class="fas fa-save"></i> Update User</span>
