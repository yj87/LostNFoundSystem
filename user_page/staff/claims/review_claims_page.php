...
<head>
    ...
    <title>Staff - Review Claims</title>
...
<body>
        ...
        <div class="main-content">
            ...
            <article class="content-area">
                <div class="page-header">
                    <h1>Review Claim</h1>
                    <p>Compare the claimant's evidence with the found item details</p>
                </div>
                ...
                <div class="review-container" id="reviewContainer" style="display: none;">
                    ...
                    <!-- CARD 5: Side-by-Side Comparison -->
    ...
    <!-- MODAL: Lost Report Details Popup -->
    <div id="lostReportModal" class="modal-overlay">
        <div class="modal-container">
            ...
            <div class="modal-body" id="lostReportModalBody">
