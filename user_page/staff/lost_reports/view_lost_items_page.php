...
<head>
    ...
    <title>Staff - View Lost Items</title>
    <link rel="stylesheet" href="view_lost_items.css">
...
<body>
        ...
        <div class="main-content">
            <header class="top-header">
                <div class="header-left">
                    ...
                    <div class="page-title-header">Lost Items Management</div>
                </div>
            ...
            <article class="content-area">
                <div class="page-header">
                    <h1>Lost Items</h1>
                    <p>View all lost item reports from users</p>
                </div>
    ...
    <script src="view_lost_items.js"></script>
    <script>
